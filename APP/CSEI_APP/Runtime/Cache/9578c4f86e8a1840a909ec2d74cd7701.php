			...
			<div class="app-content">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<?php if($cost_info->id > 0): ?><input type="hidden" name="id" value="<?php echo ($cost_info->id); ?>"/><?php endif; ?>
							<div class="row">
								<div class="col-md-12">
									<div class="invoice">
										<table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
											<tbody>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="old_price" class="form-control" placeholder=""  value="<?php echo ($cost_info->old_price); ?>">
															</div>
													</td>
													<td>其他费用一:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="other_price_one" class="form-control" placeholder="" value="<?php echo ($cost_info->other_price_one); ?>" >
															</div>
													</td>
													<td>附加价格:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="add_price" class="form-control" placeholder=""  value="<?php echo ($cost_info->add_price); ?>">
															</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="other_price_two" class="form-control" placeholder=""  value="<?php echo ($cost_info->other_price_two); ?>">
															</div>
													</td>
													<td>外币金额:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="foreign_price" class="form-control" placeholder="" value="<?php echo ($cost_info->foreign_price); ?>" >
															</div>
													</td>
													<td>其他费用三:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="other_price_three" class="form-control" placeholder=""  value="<?php echo ($cost_info->other_price_three); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="sum_price" class="form-control" placeholder=""  value="<?php echo ($cost_info->sum_price); ?>">
															</div>
													</td>
													<td>代理费:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="act_price" class="form-control" placeholder=""  value="<?php echo ($cost_info->act_price); ?>">
															</div>
													</td>
												</tr>
										</table>
