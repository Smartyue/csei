...
<div class="search-form">
	...
	<li class="active open"><a href="javascript:void(0)">
		...
		<ul class="sub-menu">
			...
			<li class="active"><a href="<?php echo U('Meterage/sub_sheet');?>"><span class="title">送检清单</span>
				...
				<div class="main-content">
					...
					<!-- start: PAGE TITLE -->
						...
						<div class="container-fluid container-fullw bg-white" style="margin-bottom: 150px;">
							<div class="row">
							<form action="<?php echo U('Meterage/submit_sub_sheet');?>" method="POST">
								<div class="col-md-12">
									<div class="invoice">
										<div class="row invoice-logo">
											...
											<div class="col-sm-6">
												<p class="text-dark">
												<input type="hidden" name="send_date" value="<?php echo ($today); ?>" />
													<?php echo ($today); ?><small class="text-light"> 请确认送检日期及信息 </small>
												</p>
											</div>
										</div>
										<hr>
										...
										<?php if(is_array($sub_list)): foreach($sub_list as $key=>$vo): ?><tr>
												...
												<td>
														...
														<input type="hidden" name="dev_id[]" value="<?php echo ($vo["dev_id"]); ?>" />
															<input type="text" name="dev_others[]" class="form-control" placeholder="输入设备附件" value="<?php echo ($vo["dev_others"]); ?>" style="width: 160px;">
														</div>
												</td>
												<td>
														<div class="form-group" style="z-index: 5;margin-bottom: 0px;width: 240px;">
															<select name="dept_id[]" class="cs-select cs-skin-slide">
																...
																<?php if(is_array($dept_list)): $i = 0; $__LIST__ = $dept_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dept): $mod = ($i % 2 );++$i; if($vo["dept_id"] == $dept['id']): ?><option value="<?php echo ($dept["id"]); ?>" selected="selected"><?php echo ($dept["name"]); ?></option>
																<?php else: ?>
																<option value="<?php echo ($dept["id"]); ?>"><?php echo ($dept["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
															</select>
														</div>
												</td>
												<td>
														<div class="form-group" style="padding-top: 14px;margin-bottom: 4px;">
															<input type="text" name="submitter[]" class="form-control" placeholder="输入送检人"  value="<?php echo ($vo["submitter"]); ?>" style="width: 175px;">
														</div>
														<p class="input-group input-append datepicker date" style="width: 180px; padding-left: 0px;">
															<input type="text" class="form-control" placeholder="选择送检日期"  name="date[]" value="<?php echo ($vo["date"]); ?>"/>
