...
<!-- start: CSS REQUIRED FOR THIS PAGE ONLY -->
		<link href="__PUBLIC__/vendor/Jcrop/jquery.Jcrop.min.css" rel="stylesheet" media="screen">
...
<div class="search-form">
	...
	<li class="active open"><a href="javascript:void(0)">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-10">
									<h1 class="mainTitle"><?php echo ($end_date); ?>-<?php echo ($dev_name); ?>检定证书</h1>
									<span class="mainDescription">设备编号：<?php echo ($dev_no); ?> ／ 规格型号：<?php echo ($spec); ?></span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>检定证书</span>
						...
						<div class="container-fluid container-fullw" style="padding-top: 12px;padding-bottom: 0px;">
							<div class="row ">
								<div class="col-md-3">
									<h5 class="over-title"><span class="text-bold">证书详情</span></h5>
									<p  >
										<?php echo ($page); ?>
									</p>
								</div>
								<div  class="col-sm-2" style="float: right; min-width: 165px; position: relative; width: 11%; margin-bottom: 20px; margin-top: 5px; margin-right: 20px;">
									<a href="<?php echo U('Device/show_info',array('id'=>$dev_id));?>" class="btn btn-primary btn-o add-event" style="width: 156px;"><i class="fa fa-server"></i> 查看设备详情</a>
								</div>
								<div  class="col-sm-2" style="float: right; min-width: 90px; position: relative; width: 6%; margin-bottom: 20px; margin-top: 5px;">
									<a href="#newFullEvent" class="btn btn-primary btn-o add-event" style="width: 80px;" ><i class="fa fa-print"></i> 打印</a>
								</div>
								
								<div class="col-sm-2"  style="float: right; min-width: 90px; position: relative; width: 6%; margin-bottom: 20px; margin-top: 5px;">
									<a href="__APP__/Meterage/down_photo/id/<?php echo ($ver_id); ?>" class="btn btn-primary btn-o add-event" style="width: 80px;"><i class="fa fa-download"></i> 下载</a>
								</div>
							</div>
						</div>
						<div class="container-fluid container-fullw">
							<div class="row">
							<?php if(is_array($list)): foreach($list as $key=>$vo): ?><div class="col-md-12" style="padding-left: 15%;">
									<img src="__ROOT__/<?php echo ($vo["photo_url"]); ?>" id="target2" alt="[Jcrop Example]" />
									<div id="preview-pane">
										<div class="preview-container">
											<img src="__ROOT__/<?php echo ($vo["photo_url"]); ?>" class="jcrop-preview" alt="Preview" />
										</div>
									</div>
		...
		<script src="__PUBLIC__/vendor/Jcrop/jquery.Jcrop.min.js"></script>
		<script src="__PUBLIC__/vendor/Jcrop/jquery.color.js"></script>
		<!-- end: JAVASCRIPTS REQUIRED FOR THIS PAGE ONLY -->
		<!-- start: CLIP-TWO JAVASCRIPTS -->
		<script src="__PUBLIC__/assets/js/main.js"></script>
		<!-- start: JavaScript Event Handlers for this page -->
		<script src="__PUBLIC__/assets/js/form-image-cropping.js"></script>
		<script>
