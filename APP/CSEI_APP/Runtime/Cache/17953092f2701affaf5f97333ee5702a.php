			...
			<div class="app-content">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<form action="__APP__/Device/sup_update" method="POST">
						<input type="hidden" name="dev_id" value="<?php echo ($dev_id); ?>" />
						<?php if($sup_info->id > 0): ?><input type="hidden" name="id" value="<?php echo ($sup_info->id); ?>"/><?php endif; ?>
							<div class="row">
								<div class="col-md-12">
									<div class="invoice">
										<table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
											<tbody>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="sup_name" class="form-control" placeholder=""  value="<?php echo ($sup_info->sup_name); ?>">
															</div>
													</td>
													<td>供应商电话:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="sup_tel" class="form-control" placeholder="" value="<?php echo ($sup_info->sup_tel); ?>">
															</div>
													</td>
													<td>供应商手机:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="sup_phone" class="form-control" placeholder="" value="<?php echo ($sup_info->sup_phone); ?>">
															</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="mfrs_name" class="form-control" placeholder=""  value="<?php echo ($sup_info->mfrs_name); ?>">
															</div>
													</td>
													<td>制造单位电话:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="mfrs_tel" class="form-control" placeholder=""  value="<?php echo ($sup_info->mfrs_tel); ?>">
															</div>
													</td>
													<td>制造单位手机:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="mfrs_phone" class="form-control" placeholder=""  value="<?php echo ($sup_info->mfrs_phone); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="act_name" class="form-control" placeholder="" value="<?php echo ($sup_info->act_name); ?>" >
															</div>
													</td>
													<td>代理商电话:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="act_tel" class="form-control" placeholder="" value="<?php echo ($sup_info->act_tel); ?>" >
															</div>
													</td>
													<td>代理商手机:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="act_phone" class="form-control" placeholder=""  value="<?php echo ($sup_info->act_phone); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="repair_name" class="form-control" placeholder=""  value="<?php echo ($sup_info->repair_name); ?>">
															</div>
													</td>
													<td>维修维护商电话:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="repair_tel" class="form-control" placeholder="" value="<?php echo ($sup_info->repair_tel); ?>">
															</div>
													</td>
													<td>维修维护商手机:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="repair_phone" class="form-control" placeholder="" value="<?php echo ($sup_info->repair_phone); ?>" >
															</div>
													</td>
												</tr>
										</table>
