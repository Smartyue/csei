				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white" style="margin-bottom: 150px;">
							...
							<form class="form-login"  action="__URL__/insert_user" method="POST">
								<div class="col-md-12">
									<table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
											<tbody>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="nickname" class="form-control" placeholder="请输入用户昵称"  required="required">
															</div>
													</td>
													<td>账号:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="username" class="form-control" placeholder="请输入用户登录账号" required="required" >
															</div>
													</td>
													<td>密码:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="password" name="password" class="form-control" placeholder="登录密码" required="required" >
															</div>
													</td>
												</tr>
												<tr>
												...
												<td>
												<div class="form-group" style="padding-top: 14px;">
																<input type="email" name="email" class="form-control" placeholder="用户邮箱,用于重置密码" required="required" >
												</div>
												</td>
												<td></td>
												<td></td>
