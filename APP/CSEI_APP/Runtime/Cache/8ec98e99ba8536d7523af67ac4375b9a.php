			...
			<div class="app-content">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<form action="__APP__/Device/tech_update" method="POST">
						<input type="hidden" name="dev_id" value="<?php echo ($dev_id); ?>" />
						<?php if($tech_info->id > 0): ?><input type="hidden" name="id" value="<?php echo ($tech_info->id); ?>"/><?php endif; ?>
							<div class="row">
								<div class="col-md-12">
									<div class="invoice">
										<table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
											...
											<tbody>
												<tr>
													...
													<td>
														<p class="input-group input-append datepicker date" style="width: 200px; padding-left: 0px;padding-top: 14px;">
															<input type="text" class="form-control" placeholder="选择投用日期"  name="date" value="<?php echo ($tech_info->date); ?>"/>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="years" class="form-control" placeholder=""  value="<?php echo ($tech_info->years); ?>">
															</div>
													</td>
													<td>规格型号:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="spec" class="form-control" placeholder=""  value="<?php echo ($tech_info->spec); ?>">
															</div>
													</td>
												</tr>
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="precise" class="form-control" placeholder=""  value="<?php echo ($tech_info->precise); ?>">
															</div>
													</td>
													<td>测量范围: </td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="dev_range" class="form-control" placeholder=""  value="<?php echo ($tech_info->dev_range); ?>">
															</div>
													</td>
													<td>设备功能: </td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="function" class="form-control" placeholder=""  value="<?php echo ($tech_info->function); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="tech_spec" class="form-control" placeholder=""  value="<?php echo ($tech_info->tech_spec); ?>">
															</div>
													</td>
													<td></td>
													<td></td>
