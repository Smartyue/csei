				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle">扫描仪管理</h1>
								</div>
								<div class="col-sm-2" style="float: right; min-width: 165px; position: relative; width: 11%; margin-bottom: 20px; margin-top: 5px;">
									<a href="<?php echo U('Admin_csei_format/add_scan');?>" class="btn btn-primary btn-o add-event" style="width: 156px;"><i class="fa ti-plus"></i> 添加新仪器</a>
								</div>
							</div>
						</section>
							...
							<div class="row">
								<div class="col-md-12">
									<table class="table table-striped table-bordered table-hover table-full-width " id="sample_1">
										...
										<tbody>
										<?php if(is_array($scan_list)): foreach($scan_list as $key=>$vo): ?><tr>
												<td><?php echo ($vo["machine_id"]); ?></td>
												...
												<td>
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu dropdown-light pull-right">
															<li>
																<a href="__URL__/edit_scan/scan_id/<?php echo ($vo["id"]); ?>">
																	编辑
																</a>
															</li>
															<li>
																<a href="__URL__/delete_scan/scan_id/<?php echo ($vo["id"]); ?>">
																	删除
																</a>
															</li>
