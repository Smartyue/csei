				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white" style="margin-bottom: 150px;">
							<div class="row">
							<form action="__URL__/update_scan" method="POST">
							<input type="hidden" name="id" value="<?php echo ($scan_info->id); ?>" />
								<div class="col-md-12">
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="machine_id" class="form-control" placeholder="" required="required" value="<?php echo ($scan_info->machine_id); ?>" >
															</div>
													</td>
													<td>扫描仪名称：</td>
													<td>
													<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="name" class="form-control" placeholder="" required="required"  value="<?php echo ($scan_info->name); ?>">
															</div>
													</td>
												</tr>
								...
								<div class="row">
										<div class="col-sm-12 invoice-block" style="margin-top: 25px;">
											...
											<a href="__URL__/scan" class="btn btn-lg btn-primary btn-o hidden-print">
												返回 <i class="fa fa-times"></i>
											</a>
										</div>
									</div>
									</form>
