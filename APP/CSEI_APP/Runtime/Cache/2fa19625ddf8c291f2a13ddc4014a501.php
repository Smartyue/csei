...
<div class="search-form">
	...
	<li class="active open"><a href="javascript:void(0)">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">上传检定证书</h1>
									<span class="mainDescription">请您及时完成待上传证书信息编辑<small>并及时查看已完成证书</small></span>
								</div>
								<ol class="breadcrumb">
									<li>
										<span>检定证书</span>
										...
										<?php if(is_array($ver_list)): foreach($ver_list as $key=>$vo): ?><tr>
												...
												<td>
													<div class="visible-md visible-lg ">
														<a href="<?php echo U('Meterage/upload_license',array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" title="查看/上传检定证书"><i class="fa fa-upload fa fa-white"></i></a>
													   <a href="javascript:;" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" title="提交检定证书" onclick="sub_license(<?php echo ($vo["id"]); ?>);"><i class="fa fa-share fa fa-white"></i></a>
													</div>
												</td>
		...
		<script>
			...
			function sub_license(ver_id){
				if(confirm("确定提交？请确保您已上传证书")){
					window.location.href="__APP__/Meterage/sub_license/ver_id/"+ver_id;
				}
			}
		</script>
