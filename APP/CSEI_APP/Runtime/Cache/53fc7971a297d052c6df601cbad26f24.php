			...
			<div class="app-content">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<form action="__APP__/Device/base_update" method="POST">
						<?php if($base_info->id > 0): ?><input type="hidden" name="dev_id" value="<?php echo ($base_info->id); ?>"/><?php endif; ?>
							<div class="row">
								<div class="col-md-12">
										...
										<tbody>
											<tr>
												...
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="dev_no" class="form-control" placeholder="" value="<?php echo ($base_info->dev_no); ?>" required="required">
														</div>
												</td>
												<td>设备名称:</td>
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="dev_name" class="form-control" placeholder=""  required="required" value="<?php echo ($base_info->dev_name); ?>">
														</div>
												</td>
												<td>设备类型:</td>
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="dev_typeid" class="cs-select cs-skin-slide">
																<option value="" disabled>选择设备类型</option>
																<?php if(is_array($type_list)): $i = 0; $__LIST__ = $type_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($base_info->dev_typeid == $vo['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option>
																<?php else: ?>
											...
											<tr>
												...
												<td>
														...
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="dev_sn" class="form-control" placeholder=""   value="<?php echo ($base_info->dev_sn); ?>">
														</div>
												...
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="asset_name" class="form-control" placeholder="" value="<?php echo ($base_info->asset_name); ?>">
														</div>
												</td>
												<td>固定资产分类编码:</td>
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="asset_sn" class="form-control" placeholder="" value="<?php echo ($base_info->asset_sn); ?>">
														</div>
												</td>
											</tr>
											<tr>
												...
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="asset_property" class="cs-select cs-skin-slide">
															<?php if($base_info->asset_property == 1): ?><option value="1"  selected="selected">是</option>
															<option value="2" >否</option>
															<?php elseif($base_info->asset_property == 2): ?>
												...
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="asset_no" class="form-control" placeholder="" value="<?php echo ($base_info-> asset_no); ?>">
														</div>
												</td>
												<td>设备属性A:</td>
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="property_a" class="cs-select cs-skin-slide">
															<?php if($base_info->property_a == 1): ?><option value="1" selected="selected">办公</option>
															<?php else: ?>
															<option value="1">办公</option><?php endif; ?>
															<?php if($base_info->property_a == 2): ?><option value="2" selected="selected">检验</option>
															<?php else: ?>
															<option value="2">检验</option><?php endif; ?>
															<?php if($base_info->property_a == 3): ?><option value="3" selected="selected">软件</option>
															<?php else: ?>
															<option value="3">软件</option><?php endif; ?>
															<?php if($base_info->property_a == 4): ?><option value="4" selected="selected">专用</option>
															<?php else: ?>
															<option value="4">专用</option><?php endif; ?>
															</select>
														</div>
												</td>
											</tr>
											<tr>
												...
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="property_b" class="cs-select cs-skin-slide">
																<?php if($base_info->property_b == 1): ?><option value="1" selected="selected">检验</option>
																<?php else: ?>
																<option value="1">检验</option><?php endif; ?>
																<?php if($base_info->property_b == 2): ?><option value="2" selected="selected">科研</option>
																<?php else: ?>
																<option value="2">科研</option><?php endif; ?>
															</select>
														</div>
												</td>
												<td>设备属性C:</td>
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="property_c" class="cs-select cs-skin-slide">
															<?php if($base_info->property_c == 1): ?><option value="1" selected="selected">是</option>
															<?php else: ?>
															<option value="1">是</option><?php endif; ?>
															<?php if($base_info->property_c == 2): ?><option value="2" selected="selected">否</option>
															<?php else: ?>
															<option value="2">否</option><?php endif; ?>
															</select>
														</div>
												...
												<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="app_property_id" class="cs-select cs-skin-slide">
																<option value="" disabled >选择应用属性</option>
																<?php if(is_array($app_list)): $i = 0; $__LIST__ = $app_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($base_info->app_property_id == $vo['id']): ?><option value="<?php echo ($vo["id"]); ?>" selected="selected"><?php echo ($vo["name"]); ?></option>
																<?php else: ?>
																<option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
															</select>
														</div>
											...
											<tr>
												...
												<td>
														<div class="form-group" style="padding-top: 14px;">
															<input type="text" name="file_no" class="form-control" placeholder="" value="<?php echo ($base_info->file_no); ?>">
														</div>
												</td>
												<td></td>
												<td>
