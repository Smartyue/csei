			...
			<div class="app-content">
				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<form action="__APP__/Device/manage_update" method="POST">
						<input type="hidden" name="dev_id" value="<?php echo ($dev_id); ?>"/>
						<?php if($manage_info->id > 0): ?><input type="hidden" name="id" value="<?php echo ($manage_info->id); ?>" /><?php endif; ?>
							<div class="row">
								<div class="col-md-12">
									<div class="invoice">
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="use_dept" class="form-control" placeholder=""  value="<?php echo ($manage_info->use_dept); ?>">
															</div>
													</td>
													<td>部门设备管理员:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="dept_admin" class="form-control" placeholder=""  value="<?php echo ($manage_info->dept_admin); ?>">
															</div>
													</td>
													<td>使用人:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="dev_user" class="form-control" placeholder=""  value="<?php echo ($manage_info->dev_user); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="manage_dept" class="form-control" placeholder="" value="<?php echo ($manage_info->manage_dept); ?>" >
															</div>
													</td>
													<td>院管理员: </td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="yard_admin" class="form-control" placeholder=""  value="<?php echo ($manage_info->yard_admin); ?>">
															</div>
													</td>
													<td>设备技术负责人:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="tech_admin" class="form-control" placeholder=""  value="<?php echo ($manage_info->tech_admin); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="use_percent" class="form-control" placeholder=""  value="<?php echo ($manage_info->use_percent); ?>">
															</div>
													</td>
													<td>使用费:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="use_price" class="form-control" placeholder=""  value="<?php echo ($manage_info->use_price); ?>">
															</div>
													</td>
													<td>备注:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="note" class="form-control" placeholder="" value="<?php echo ($manage_info->note); ?>" >
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
														<div class="form-group" style="margin-bottom: 0px;">
															<select name="manage_method" class="cs-select cs-skin-slide">
																<?php if($manage_info->manage_method == 1): ?><option value="1" selected="selected">出让</option>
																<?php else: ?>
																<option value="1">出让</option><?php endif; ?>
																<?php if($manage_info->manage_method == 2): ?><option value="2" selected="selected">报废</option>
																<?php else: ?>
																<option value="2">报废</option><?php endif; ?>
																<?php if($manage_info->manage_method == 3): ?><option value="3" selected="selected">无偿调拨</option>
																<?php else: ?>
																<option value="3">无偿调拨</option><?php endif; ?>
																<?php if($manage_info->manage_method == 4): ?><option value="4" selected="selected">有偿调拨</option>
																<?php else: ?>
																<option value="4">有偿调拨</option><?php endif; ?>
																<?php if($manage_info->manage_method == 5): ?><option value="5" selected="selected">其他</option>
																<?php else: ?>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="manage_reason" class="form-control" placeholder=""  value="<?php echo ($manage_info->manage_reason); ?>">
															</div>
													</td>
													<td>处置方式其他:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="manage_method_other" class="form-control" placeholder=""  value="<?php echo ($manage_info->manage_method_other); ?>">
															</div>
													</td>
												</tr>
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="manage_name" class="form-control" placeholder=""  value="<?php echo ($manage_info->manage_name); ?>">
															</div>
													</td>
													<td>财务资产编号:</td>
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="finance_no" class="form-control" placeholder=""  value="<?php echo ($manage_info->finance_no); ?>">
															</div>
													</td>
													<td></td>
													<td>
