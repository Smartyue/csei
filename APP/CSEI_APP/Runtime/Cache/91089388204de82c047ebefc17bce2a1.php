				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<div class="container-fluid container-fullw bg-white" style="margin-bottom: 150px;">
							<div class="row">
							<form action="__URL__/update_label" method="POST">
							<input type="hidden" name="id" value="<?php echo ($lab_info->id); ?>" />
								<div class="col-md-12">
												...
												<tr>
													...
													<td>
															<div class="form-group" style="padding-top: 14px;">
																<input type="text" name="label" class="form-control" placeholder="" required="required"  value="<?php echo ($lab_info->label); ?>">
															</div>
													</td>
													<td></td>
												</tr>
								...
								<div class="row">
										<div class="col-sm-12 invoice-block" style="margin-top: 25px;">
											...
											<a href="__URL__/label" class="btn btn-lg btn-primary btn-o hidden-print">
