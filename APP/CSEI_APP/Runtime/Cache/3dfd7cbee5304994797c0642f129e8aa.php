...
<div class="search-form">
	...
	<li class="active open"><a href="javascript:void(0)">
		...
		<ul class="sub-menu">
			<li class="active"><a href="<?php echo U('Label/index');?>"> <span
					class="title"> 电子标签绑定管理 </span>
			</a></li>
										...
										<div class="col-sm-3" style="width: 195px;">
											<div class="panel panel-white no-radius text-center">
												<div class="panel-body">
													...
													<h3 style="margin-top: 10px;" class="links cl-effect-1 StepTitle"><a href="<?php echo U('Label/bind_index');?>">最近绑定</a></h2>
						...
						<div class="container-fluid container-fullw" style="padding-top: 12px;padding-bottom: 0px;">
							<div class="row ">
								<div class="col-md-3">
									...
									<p  >
										共<?php echo ($bind_count); ?>条已绑定设备，剩余电子标签<?php echo ($un_bind_count); ?>个可用于绑定设备
									</p>
								</div>
												...
												<td>
													<div class="btn-group">
										              ...
										              <ul role="menu" class="dropdown-menu dropdown-light pull-right">
											                ...
											                <li>
											                <?php if($vo["lab_name"] != null): ?><a href="__APP__/Label/un_bind/dev_id/<?php echo ($vo["id"]); ?>">取消绑定关系</a>
												            <?php else: ?>
												                 <a href="__APP__/Label/bind/dev_id/<?php echo ($vo["id"]); ?>">分配标签绑定</a><?php endif; ?>
											                </li>
										             </ul>
									             </div>
												</td>
            ...
            function bind_list(){
            	...
            	if(dev_list.length==0){
            		...
            		if(confirm("确定要为选中的设备分配标签？")){
            			if(dev_list.length<=<?php echo ($un_bind_count); ?>){
