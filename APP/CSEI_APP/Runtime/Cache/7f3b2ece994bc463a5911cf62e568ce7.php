				...
				<div class="main-content">
					<div class="wrap-content container" id="container">
						...
						<section id="page-title" class="padding-top-15 padding-bottom-15">
							<div class="row">
								<div class="col-sm-7">
									<h1 class="mainTitle">送检单位管理</h1>
								</div>
								<div class="col-sm-2" style="float: right; min-width: 165px; position: relative; width: 11%; margin-bottom: 20px; margin-top: 5px;">
									<a href="<?php echo U('Admin_csei_format/add_dept');?>" class="btn btn-primary btn-o add-event" style="width: 156px;"><i class="fa ti-plus"></i> 添加送检单位</a>
								</div>
							</div>
						</section>
												...
												<td>
													<div class="btn-group">
														...
														<ul role="menu" class="dropdown-menu dropdown-light pull-right">
															<li>
																<a href="__URL__/edit_dept/dept_id/<?php echo ($vo["id"]); ?>">
																	编辑
																</a>
															</li>
															<li>
																<a href="__URL__/delete_dept/dept_id/<?php echo ($vo["id"]); ?>">
																	删除
																</a>
															</li>
