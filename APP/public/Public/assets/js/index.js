'use strict';
var Index = function() {
	var chart1Handler = function(data_last,data_now) {
		var data = {
	...
	var chart2Handler = function(dev_num_last,dev_num_now) {
		// Chart.js Data
		var data = {
	...
	return {
		init: function(data_last,data_now,dev_num_last,dev_num_now) {
			chart1Handler(data_last,data_now);
			chart2Handler(dev_num_last,dev_num_now);
			chart3Handler();
			chart4Handler();
			sparklineHandler();
		}
