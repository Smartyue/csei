...
var Main = function() {
	...
	var settingsHandler = function() {
		...
		$('#skin_color').attr("href", "/Public/assets/css/themes/" + appSetting.theme + ".css");
		...
		$('input[name="setting-theme"]').change(function() {
			...
			$('#skin_color').attr("href", "/Public/assets/css/themes/" + selectedTheme + ".css");
			switchLogo(selectedTheme);
			appSetting.theme = selectedTheme;
			$.cookie("clip-setting", JSON.stringify(appSetting),{path:'/'});
		...
		function switchLogo(theme) {
			switch (theme) {
				...
				case "theme-5":
				case "theme-6":
					$(".navbar-brand img").attr("src", "/Public/assets/images/logo.png");
					break;
		...
		function defaultSetting() {
			...
			$('#skin_color').attr("href", "/Public/assets/css/themes/theme-1.css");
			$(".navbar-brand img").attr("src", "/Public/assets/images/logo.png");
